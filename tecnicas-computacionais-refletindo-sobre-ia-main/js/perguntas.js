export const perguntas = [
    {
        enunciado: "Você chegou a noite, o que vai fazer?",
        alternativas: [
            {
                texto: "Ir a tumba",
                afirmacao: [
    ...
    {
        enunciado: "Você prescisa de um meio de transporte para chgar ate a pirâmide",
        alternativas: [
            {
                texto: "Ir de jipe",
                afirmacao: [
    ...
    {
        enunciado: "Vocês arrumaram o carro e seguiram para a tumba. Ao chegar lá você se deparou com duas entradas,para qual você vai? ",
        alternativas: [
            {
                texto: " Entrada com o símbolo de Ísiswdd",
                afirmacao: [
            ...
            {
                texto: "Entrada com o símbolo de Osíris",
                afirmacao: [
